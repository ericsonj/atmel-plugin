...
@TemplateRegistration(folder = "Project/Atmel", displayName = "#Atmel_displayName", description = "AtmelDescription.html", iconBase = "atmel/atmel.png", content = "AVRProject.zip")
